...
class GameOverHomeAnimation extends BaseAnimation {
  // The start center position of the full screen animation
  Offset startCenter = const Offset(30, 80);
  ...
  Size startSize = const Size(65, 12.5);
  ...
  Future<void> loadResource() async {
    _homeImage = await Flame.images.load('home.png');
  }
}
