...
class BeginSettingAnimation extends BaseAnimation {
  ...
  GameState? targetGameState = GameState.setting;

  // The start center position of the full screen animation
  Offset startCenter = Offset(32.5, 68.75);
  ...
  void renderOnCanvas(Canvas canvas, Size screenSize) {
    ...
    // Warning when the frame index is invalid but this function is called
      ...
      print("Warning: BeginSettingAnimation::renderOnCanvas(Canvas, Size) called, but the frameIndex: ${frameIndex} is invalid.");
    }
  }
  ...
  double _toAbsoluteWidth(double relativeWidth) {
    ...
    if(screenSize == null) {
      print("Error: screenSize need to be set before BeginSettingAnimation::_toAbsoluteWidth(double relativeWidth) being invoked.");
      return 0;
    }
  ...
  double _toAbsoluteHeight(double relativeHeight) {
    final screenSize = this.screenSize;
    if(screenSize == null) {
      print("Error: screenSize need to be set before BeginSettingAnimation::_toAbsoluteHeight(double relativeHeight) being invoked.");
      return 0;
    }
