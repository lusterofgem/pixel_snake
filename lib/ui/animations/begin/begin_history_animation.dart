...
class BeginHistoryAnimation extends BaseAnimation {
  ...
  GameState? targetGameState = GameState.history;

  // The start center position of the full screen animation
  Offset startCenter = Offset(67.5, 68.75);
  ...
  Color startColor = Color(0xFFCC69EB);
  // The end color of the animation
  Color endColor = Color(0xFFAB69D0);
  ...
  void renderOnCanvas(Canvas canvas, Size screenSize) {
    ...
    // Warning when the frame index is invalid but this function is called
      ...
      print("Warning: BeginHistoryAnimation::renderOnCanvas(Canvas, Size) called, but the frameIndex: ${frameIndex} is invalid.");
    }
  }
  ...
  double _toAbsoluteWidth(double relativeWidth) {
    ...
    if(screenSize == null) {
      print("Error: screenSize need to be set before BeginHistoryAnimation::_toAbsoluteWidth(double relativeWidth) being invoked.");
      return 0;
    }
  ...
  double _toAbsoluteHeight(double relativeHeight) {
    final screenSize = this.screenSize;
    if(screenSize == null) {
      print("Error: screenSize need to be set before BeginHistoryAnimation::_toAbsoluteHeight(double relativeHeight) being invoked.");
      return 0;
    }
